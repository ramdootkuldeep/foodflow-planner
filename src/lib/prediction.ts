...
const DISH_MATERIALS: Record<string, RawMaterial[]> = {
  ...
  'Omelette': [{ name: 'Eggs', perPerson: 0.12, demandFactor: 1.2 }, { name: 'Onion', perPerson: 0.02, demandFactor: 1.0 }],
  'Boiled Egg': [{ name: 'Eggs', perPerson: 0.12, demandFactor: 1.0 }],
  ...
  'Egg Curry': [{ name: 'Eggs', perPerson: 0.14, demandFactor: 1.2 }, { name: 'Onion', perPerson: 0.04, demandFactor: 1.0 }, { name: 'Tomato', perPerson: 0.04, demandFactor: 1.0 }],
